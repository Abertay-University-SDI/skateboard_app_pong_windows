...
namespace CMP203
{
	...
	constexpr static uint8_t PIPELINE_PERMUTATIONS = (DEPTH_TEST | ALPHA_BLEND | WIREFRAME | LIT) + 1;

	class Renderer203 : public Skateboard::IRendererSystem
	{
		Skateboard::ShaderInputLayoutRef RootSig;

		//pipeline permutations
		std::array<Skateboard::PipelineRef, PIPELINE_PERMUTATIONS> Pipelines;
